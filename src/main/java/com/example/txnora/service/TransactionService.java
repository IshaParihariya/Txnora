...
public class TransactionService
{
    ...
    public Transaction createTransactionService(CreateTransactionRequest request)
    {
        ...
        //for idempotency eventId java is generating
        //UUID => Universally Unique Identifier.
        //It's a standard way of generating an ID that is extremely unlikely to collide with another generated ID
        event.eventId= UUID.randomUUID().toString();
        event.transactionId = savedTransaction.getId(); //GENERATED BY MONGODB
